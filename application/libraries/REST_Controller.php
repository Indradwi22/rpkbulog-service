...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __construct($config = 'rest')
    {
      ...
      //  $this->jasper_server = 'http://localhost:8080/jasperserver'; //'http://akli.mstechsoft.com:8080/jasperserver'
        $this->jasper_server = 'http://akli.mstechsoft.com:8080/jasperserver';
